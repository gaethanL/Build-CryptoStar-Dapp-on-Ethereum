...
contract StarNotary is ERC721 {
    ...
    string public constant nameS = "Stars"; 
    string public constant symbole = "STR";
    constructor() public ERC721(nameS, symbole){}
   ...
   function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory, address) {
        //1. You should return the Star saved in tokenIdToStarInfo mapping
        address owner =  ownerOf(_tokenId);
        return (tokenIdToStarInfo[_tokenId].name, owner);
    }
